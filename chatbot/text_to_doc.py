...
1. The clean_text() function is used to clean the text content by applying a series of cleaning functions.  
2. The text_to_docs() function is used to convert the cleaned text content into a list of Document objects with associated metadata.
3. The get_doc_chunks() function takes the raw text content and metadata, clean the text, and divide it into document chunks.
4. The get_doc_chunks() function returns a list of Document objects with processed text content and associated metadata.
"""
